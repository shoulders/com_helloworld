...
<?php if ($this->parentItem->id > 1) : ?>
	<h1><?php echo Text::_('COM_QWHELLOWORLD_PARENT') ?>
	</h1>
	<h3>
		<?php $url = Route::_('index.php?option=com_qwhelloworld&view=project&id=' . $this->parentItem->id . ':' . $this->parentItem->alias . '&catid=' . $this->parentItem->catid . $query_lang); ?>
		<a href="<?php echo $url; ?>"><?php echo $this->parentItem->title; ?></a>
	</h3>
<?php endif; ?>

<?php if ($this->children) : 
		$baseLevel = $this->item->level; ?>
		<h1><?php echo Text::_('COM_QWHELLOWORLD_CHILDREN') ?>
		</h1>
		<?php foreach ($this->children as $i => $child) : ?>
			<h3>
				...
				<?php echo $prefix; ?>
				<?php $url = Route::_('index.php?option=com_qwhelloworld&view=project&id=' . $child->id . ':' . $child->alias . '&catid=' . $child->catid . $query_lang); ?>
				<a href="<?php echo $url; ?>"><?php echo $child->title; ?></a>
			</h3>
	<?php endforeach; ?>
<?php endif; ?>
...
<?php
    ...
    $fields = FieldsHelper::getFields('com_qwhelloworld.project', $this->item, true);
...
<div class="map-callout map-callout-bottom" id="title-container"></div>
<div id="searchmap">
    ...
    <button type="button" class="btn btn-primary" onclick="searchHere();">
        <?php echo Text::_('COM_QWHELLOWORLD_SEARCH_HERE_BUTTON') ?>
    </button>
