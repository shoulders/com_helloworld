...
/**
 * Qwhelloworld List Model
 *
 * @since  0.0.1
 */
class QwhelloworldModelProjects extends ListModel
{
        /**
         * Constructor.
         *
        ...
        protected function getListQuery()
        {
                ...
                if (Associations::isEnabled())
                {
                        $query->select('COUNT(asso2.id)>1 as association')
                                ->join('LEFT', '#__associations AS asso ON asso.id = a.id AND asso.context=' . $db->quote('com_qwhelloworld.item'))
