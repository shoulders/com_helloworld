...
$html[] = '<label id="batch_setposition-lbl" for="batch_setposition">' .
			Text::_('COM_QWHELLOWORLD_BATCH_SETPOSITION_LABEL') . '</label>';
$html[] = '<select name="batch[position][setposition]">' .
			'<option value="keepPosition" selected>' . Text::_('COM_QWHELLOWORLD_BATCH_KEEP_POSITION') . '</OPTION>' .
			'<option value="changePosition">' . Text::_('COM_QWHELLOWORLD_BATCH_CHANGE_POSITION') . '</OPTION>' .
		  '</select>';
$html[] = '<label id="batch_latitude-lbl" for="batch_latitude">' . 
				Text::_('COM_QWHELLOWORLD_PROJECT_FIELD_LATITUDE_LABEL') . '</label>';
...
$html[] = '<label id="batch_longitude-lbl" for="batch_longitude">' . 
				Text::_('COM_QWHELLOWORLD_PROJECT_FIELD_LONGITUDE_LABEL') . '</label>';
